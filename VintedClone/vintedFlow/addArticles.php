    ...
    <div class="page-wrapper">
                            ...
                            <ul class="menu sf-arrows">
                                ...
                                <li>
                                    ...
                                    <ul>
                                        ...
                                        <li><a href="elements-blog-posts.html">Blog sPosts</a></li>
        ...
        <main class="main">
        	<div class="page-header text-center" style="background-image: url('assets/images/page-header-bg.jpg')">
        		<div class="container">
        			<h1 class="page-title">Add a <span>Products</span></h1>
        		</div><!-- End .container -->
        	</div><!-- End .page-header -->
            ...
            <div class="page-content">
                <div class="container">
                		<div class="col-sm-6 col-lg-5" style="text-align: center; font-size: 25px">
                			   Veuillez remplir les differents champs
                            <form class="contact-form mb-3" method="post" action="hotel.class.php" enctype="multipart/form-data" autocomplete="on">
                				<div class="row">
                					<div class="col-sm-6">
                                        <label for="cname" class="sr-only">Nom de l'article</label>
                						<input type="text" class="form-control" name="nomH" placeholder="Nom de l'article *" required>
                					</div><!-- End .col-sm-6 -->
                                    <div class="col-sm-6">
                                        <label for="cname" class="sr-only">Mail</label>
                						<input type="text" class="form-control" name="emailH" placeholder="Mail *" required>
                					</div><!-- End .col-sm-6 -->
                					<div class="col-sm-6">
                                        <label for="cemail" class="sr-only">Prix de l'article</label>
                						<input type="number" class="form-control" name="locaH" placeholder="Prix de l'article *" required>
                					</div><!-- End .col-sm-6 -->
                                    <div class="col-sm-6">
                                        <label for="cemail" class="sr-only">Votre numero</label>
                						<input type="number" class="form-control" name="telH" placeholder="Votre numero *" required>
                					</div><!-- End .col-sm-6 -->
                				</div><!-- End .row -->
                				...
                				<textarea class="form-control" cols="30" rows="4" name="descripH" required placeholder="Description de l'artilce *"></textarea>
                                
                                <label class="col-sm-6 col-lg-9">Selection d'images de l'hotel *
                            </label>
                             <input type="file" class="form-control" name="image[]" multiple=""  required="required">
                             <br><br>
                        ...
                        <div class="form-tab">
                            ...
                            <div class="tab-content" id="tab-content-5">
                                <div class="tab-pane fade show active" id="signin" role="tabpanel" aria-labelledby="signin-tab">
                                    <form method="post" action="src/hotel/hotel.class.php" enctype="multipart/form-data" autocomplete="on">
