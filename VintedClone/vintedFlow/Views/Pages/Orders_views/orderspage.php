...
<!-- molla/elements-tabs.html  22 Nov 2019 10:05:18 GMT -->
<head>
    <meta charset="UTF-8">
    ...
    <div class="page-wrapper">
        ...
        <main class="main">
        	<div class="page-header text-center" style="background-image: url('assets/images/page-header-bg.jpg')">
        		<div class="container">
        			<h1 class="page-title">List of gets order<span></span></h1>
        		</div><!-- End .container -->
        	</div><!-- End .page-header -->
			...
			$user_id = $_SESSION["usersvalue"];
			// Get image data from database 
			$result = $db->query("SELECT * FROM Orders WHERE ownerID = {$user_id} "); 
                	...
                	<div class="row">
                		...
                		<div class="col-md-6">
	            			<ul class="nav nav-tabs nav-tabs-bg" id="tabs-1" role="tablist">
							    <li class="nav-item">
							        <a class="nav-link active" id="tab-1-tab" data-toggle="tab" href="#tab-1" role="tab" aria-controls="tab-1" aria-selected="true">Commands: <?php echo$row['OrderID'];?></a>
							    </li>
							    
							</ul>
							<div class="tab-content tab-content-border" id="tab-content-1">
							    <div class="tab-pane fade show active" id="tab-1" role="tabpanel" aria-labelledby="tab-1-tab">
							    <a href=""><p> <h5>You have got a order for this articles</h5> </p></a>
                                <a href=""><p>Mail of User: <?php echo$row['usermail'];?></p></a>
                                <a href=""><p>UserName : <?php echo$row['Username'];?></p></a>
                                <a href=""><p>User Contact : +2250574732750</p></a>
                                <a href=""><p>Article Price : 15$</p></a>
                                <!-- <a href=""><p>Contact</p></a> -->
                                <form action="chat.php?user_id=<?php echo$_SESSION["usersvalue"];?>" method= "POST">
                                            <input type="text" value="<?php  if(isset($_SESSION['OrderID'])){   echo $_SESSION["OrderID"];
                                            } //echo $_SESSION["OrderID"] = $row['commandIDs']; ?>" name="OrderID" hidden>
                                            <button type="submit" class="btn btn-outline-primary-2" name="submit">Check My Message With This Client</button>
                                        </form>
							    </div><!-- .End .tab-pane -->
