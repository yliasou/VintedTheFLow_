                    ...
                    <div class="header-left">
                        ...
                        <nav class="main-nav">
                            <ul class="menu sf-arrows">
                                ...
                                <li>
                                    <a  href="#signin-modal" data-toggle="modal" class="sf-with-ul"><?php if(isset($_SESSION['unique_id'])){echo("ID: " .$_SESSION['unique_id']);}else{ echo("Se connecter");} ?></a>
                                    <?php if(isset($_SESSION['unique_id'])){
                                        echo('<ul>
                                        <li> <a href="UploadHotel.php?user_id=<?php echo$_SESSION["unique_id"];?>Publier un article</a></li>
        ...
        <main class="main">
            ...
            <?php 
                if (empty($_GET['erreur']))
                    {
                        echo('<h4 class="title text-center mb-2"> Quelques articles');
                    #Condition null !!
                    } 
                    else
                    {
                		...
                		<div class="col-sm-6 col-md-4">
                			<article class="entry entry-grid">
                				<figure class="entry-media">
                					<img src="data:image/jpg;charset=utf8;base64,<?php echo base64_encode($row['image']); ?>" style="width: 400px; border-radius: 0px; background-color: none;">
                				...
                				<div class="entry-body text-center">
                					...
                					<div class="entry-content">
                                        <h3><?php echo($row['Price'].' FCFA'); ?></h3>    
                                        <?php
                                            $_SESSION["usersvalue"] = $row['usersvalue'];
                                            $_SESSION["OrderID"] = $row['commandIDs'];
                                            $_SESSION["ownerID"] = $row['usersvalue'];
        ...
        <div class="mobile-menu-wrapper">
            ...
            <nav class="mobile-nav">
                <ul class="mobile-menu">
                    ...
                    <li>
                        <a href="#signin-modal" data-toggle="modal" class="sf-with-ul">Connexion</a>
                        <ul>
                            <li><a href="category-list.html">Shop List</a></li>
                            <li><a href="category-2cols.html">Shop Grid 2 Columns</a></li>
                            <li><a href="category.html">Shop Grid 3 Columns</a></li>
                        ...
                        <div class="form-tab">
                            ...
                            <div class="tab-content" id="tab-content-5">
                                ...
                                <form action="signup.php" method="POST" enctype="multipart/form-data" autocomplete="off">
                                        ...
                                        <div class="form-group">
                                            <label for="register-email">Your Username</label>
                                            <input type="text" class="form-control" id="register-email" name="lname" required>
                                        </div><!-- End .form-group -->
                                        <div class="form-group">
                                            <label for="register-email">Your Number phone</label>
                                            <input type="text" class="form-control" id="register-email" name="userphone" required>
                                        </div><!-- End .form-group -->
                                        <div class="form-group">
                                            <label for="register-email">Your Prename</label>
